    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_type', models.CharField(blank=True, choices=[('Fire', 'Fire'), ('Water', 'Water'), ('Grass', 'Grass'), ('Electric', 'Electric'), ('Psychic', 'Psychic'), ('Ice', 'Ice'), ('Dragon', 'Dragon'), ('Dark', 'Dark'), ('Normal', 'Normal'), ('Fighting', 'Fighting'), ('Flying', 'Flying'), ('Poison', 'Poison'), ('Ghost', 'Ghost'), ('Steel', 'Steel'), ('Fairy', 'Fairy'), ('Ground', 'Ground'), ('Bug', 'Bug'), ('Rock', 'Rock')], max_length=100, null=True)),
                ...
                ('card_number', models.IntegerField(blank=True, max_length=250, null=True)),
